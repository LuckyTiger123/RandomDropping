...
class Model(torch.nn.Module):
    def __init__(self, feature_num, output_num, backbone, drop_method, unbias):
        ...
        self.gnn1 = Md.OurModelLayer(feature_num, 256, drop_method, backbone, unbias=unbias, alpha=0.1, K=10)
        self.gnn2 = Md.OurModelLayer(256, output_num, drop_method, backbone, unbias=unbias, alpha=0.1, K=10)
