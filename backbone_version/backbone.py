...
class BbGCN(MessagePassing):
    def __init__(self, add_self_loops: bool = True, normalize: bool = True, unbias: float = 0):
...
class BbAPPNP(MessagePassing):
    def __init__(self, K: int, alpha: float, add_self_loops: bool = True, normalize: bool = True, unbias: float = 0):
